#!/usr/bin/env python3
"""seed_extract.py: normalize AI provider data exports into a staging area.
...
under a staging directory OUTSIDE the corpus. A CLI agent then distills the
staging area into koinome seed notes (see distill-seeds.md).
