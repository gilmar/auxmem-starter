"""Reference corpus fixtures (AUX-012)."""

from __future__ import annotations

import pytest

from koinome.evaluation import REFERENCE_NAMES, evaluate_reference
from tests.helpers import REPO_ROOT, run_conformance_check, validate_corpus
