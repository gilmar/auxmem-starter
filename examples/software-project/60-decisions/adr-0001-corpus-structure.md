---
title: ADR-0001 Open-standard agent-readable corpus
summary: Records the decision to build this corpus as a provider-independent, plain-markdown knowledge base optimized for CLI agent retrieval, governed by a validator.
type: adr
status: active
domain: engineering
created: 2026-07-04
...
## Consequences
Easier: any model reads the corpus; migration between providers is free.
