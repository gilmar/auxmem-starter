---
name: koinome-weekly-review
description: Run a guided weekly review of a corpus using graph gaps, open tasks, and recent logs. Use for weekly review, retrospective, or corpus health check at week end.
---
