---
title: ADR-0001 Open-standard agent-readable vault
summary: Records the decision to build this vault as a provider-independent, plain-markdown knowledge base optimized for CLI agent retrieval, governed by a validator.
type: adr
status: active
...
## Consequences
Easier: any model reads the vault; migration between providers is free.
